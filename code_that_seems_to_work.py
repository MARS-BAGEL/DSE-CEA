...
#with this config shit seems to work (wall temp seems to max at around like six hundren and thirty something)
#as soon as I start fucking with things it gets messed up 
...
#general 
stage = 1 #enter 1 for first stage engine, 2 for second stage engine
...
l_engine = 0.55955 #total length of engine [m]  #0.55955 for first stage, 0.40369 for second stage
